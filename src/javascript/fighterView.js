...
import { showFighterDetails } from './fightersView';    // added import
...
export function createFighter(fighter, handleClick, selectFighter) {
  ...
  const onFighterClick = (ev) => showFighterDetails(ev, fighter);   // changed handleClick to showFighterDetails
